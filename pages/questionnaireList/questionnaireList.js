Page({
    ...
    share(e) {
      wx.navigateTo({
        url: `/pages/share/share?id=${e.currentTarget.dataset.id}&qrCode=${e.currentTarget.dataset.code}&title=${e.currentTarget.dataset.title}`
      })
    },
    showContent: function (e) {
        ...
        setTimeout(function () {
            animation.height("204rpx").opacity(1).step({ duration: 300 })
            that.setData({
                animationData: animation.export(),
    ...
    hideContent: function (e) {
        ...
        that.animation = animation
        animation.height(0).opacity(0).step({ duration: 300 })
        that.setData({
            animationData: animation.export()
        })
        setTimeout(function () {
            animation.height("204rpx").step();
            that.setData({
                animationData: animation.export(),
                choose: false,
            })
